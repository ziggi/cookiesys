...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18838554895248744ddd1561-25282639',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5248744def3922_47664141',
  'variables' => 
  array (
    'uri' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5248744def3922_47664141')) {function content_5248744def3922_47664141($_smarty_tpl) {?><!DOCTYPE html>
<html>
  <head>
    <title>CookieSys</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="<?php echo $_smarty_tpl->tpl_vars['uri']->value['asset'];?>
/css/bootstrap.min.css" rel="stylesheet" media="screen">
    <link href="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/css/bootstrap-theme.min.css" rel="stylesheet" media="screen">
    <link href="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/css/navbar.css" rel="stylesheet" media="screen">
    <link href="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/css/signin.css" rel="stylesheet" media="screen">

  </head>
  <body>
    <div class="container">
      <div id="header" class="text-center">
        <img src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/img/head.png" alt="head">
      </div>
...
<div class="container">
  ...
  <p><?php echo $_smarty_tpl->tpl_vars['data']->value['text'];?>
</p>
</div>
          ...
          <div class="container">
            <div class="panel panel-default">
              <div class="panel-body text-center" style="padding: 5px">
                <a href="http://vk.com/" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/img/vk.png" alt="vk"></a>
                <a href="http://twitter.com/" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/img/twitter.png" alt="twitter"></a>
                <a href="http://youtube.com/" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/img/youtube.png" alt="youtube"></a>
                <a href="http://facebook.com/" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['template'];?>
/img/facebook.png" alt="facebook"></a>
    ...
    <script src="<?php echo $_smarty_tpl->tpl_vars['uri']->value['asset'];?>
